...
(describe "DB Common"
	...
	(context "min-by"
		...
		(it "1 attribute"
			(let [bib-min (db/tx {:kind :bibelot :name "thingy" :color "blue" :size 123})
						bib-max (db/tx {:kind :bibelot :name "thingy" :color "blue" :size 321})]
				(should= bib-min (db/min-by :bibelot :size :name "thingy"))
				(should= nil (db/min-by :bibelot :size :name "blah"))))

		(it "min-by with 4 attrs"
			(let [bibby    (db/tx {:kind :bibelot :name "bibby"})
						fizz-min (db/tx :kind :thingy :foo "paul" :bar (:id bibby) :fizz 2 :bang :paul)
						fizz-max (db/tx :kind :thingy :foo "paul" :bar (:id bibby) :fizz 7 :bang :ringo)]
				(should= fizz-min (db/min-by :thingy :fizz :foo "paul" :bar (:id bibby)))
				(should= nil (db/min-by :thingy :fizz :foo "ringo" :bar (:id bibby) :bang :paul))
				(should= nil (db/min-by :thingy :fizz :foo []))
				(should= fizz-min (db/min-by :thingy :fizz :foo ["paul"]))
				(should= fizz-max (db/min-by :thingy :fizz :bang :ringo))))
		)
	...
	(context "max-by"
		...
		(it "1 attribute"
			(let [bib-min (db/tx {:kind :bibelot :name "thingy" :color "blue" :size 123})
						bib-max (db/tx {:kind :bibelot :name "thingy" :color "blue" :size 321})]
				(should= bib-max (db/max-by :bibelot :size :name "thingy"))
				(should= nil (db/max-by :bibelot :size :name "blah"))))

		(it "max-by with 4 attrs"
			(let [bibby    (db/tx {:kind :bibelot :name "bibby"})
						fizz-min (db/tx :kind :thingy :foo "paul" :bar (:id bibby) :fizz 2 :bang :paul)
						fizz-max (db/tx :kind :thingy :foo "paul" :bar (:id bibby) :fizz 7 :bang :ringo)]
				(should= fizz-max (db/max-by :thingy :fizz :foo "paul" :bar (:id bibby)))
				(should= nil (db/max-by :thingy :fizz :foo "ringo" :bar (:id bibby) :bang :paul))
				(should= nil (db/max-by :thingy :fizz :foo []))
				(should= fizz-max (db/max-by :thingy :fizz :foo ["paul"]))
				(should= fizz-min (db/max-by :thingy :fizz :bang :paul))))
		)
	...
	(context "min"
		...
		#?(:clj  (helper/with-db-schemas [bibelot thingy])
			 :cljs (helper/with-db-schemas [bibelot thingy]))
		(before (db/tx :kind :bibelot :name "john" :color "red" :size 10)
						(db/tx :kind :bibelot :name "paul" :color "green" :size 20)
						(db/tx :kind :bibelot :name "george" :color "blue" :size 30))

		(it "min of all all bibelot/size"
			(should= 0 (db/min :thingy :foo))
			(should= 10 (db/min :bibelot :size)))
		)
	...
	(context "max"
		...
		(it "max of all all bibelot/size"
			(should= 0 (db/max :thingy :foo))
			(should= 30 (db/max :bibelot :size)))
		)
